...
#nbmaE1to8 <-  networkBMA(t(equalRepsE[ DEGE1to8, c(1:8, 18:25,35:42)]),8, verbose=T)
#save.image(file="regnetsEB")
#writeEdges( nbmaBMicroarray, threshhold = .7,fileName = file.path(path,"nbmaE1to8.txt"))


#nbmaE9to17 <-  networkBMA(t(log(equalRepsE[DEGE9to40,c(9:17,26:34,43:51)]+2,2)),9, verbose=T)
...
writeEdges( nmba1to40, threshhold = .7,fileName = file.path(path,"nbmaE1to40.txt"))
save.image(file=file.path(path,"nbmaE1to40.Rdata"))
